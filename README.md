...
- 🏆 Weekly Music XP leaderboard and all-time journey at `/leaderboard`, linked compactly from the guest page.
...
| /leaderboard | Public Top 10 weekly Music XP leaderboard and all-time journey |
...
public/leaderboard.*       Public weekly Music XP and lifetime leaderboard page
